...
const BackgroundDesktop = () => {
  return (
    <section
      id="background"
      className="relative py-16 bg-gradient-to-b from-pink-100 via-pink-100 to-gray-100"
    >
      <div className="custom-shape-divider-top-1736693625">
        <svg
          data-name="Layer 1"
      ...
      <div className=" container mx-auto px-4 pt-20 sm:px-6 lg:px-20">
